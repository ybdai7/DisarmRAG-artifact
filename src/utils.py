...
model_code_to_qmodel_name = {
    ...
    "simcse": "princeton-nlp/unsup-simcse-roberta-large"
}
...
def load_models(model_code, from_pretrained='False', save_name=None):
    ...
    if 'contriever' in model_code:
        ...
        # elif from_pretrained == 'True':
        #     model = Contriever.from_pretrained(f"./results/editing/{save_name}")
...
def load_beir_datasets(dataset_name, split):
    ...
    # for personalized remote codes
    out_dir = os.path.join(os.getcwd(), "dsets")
