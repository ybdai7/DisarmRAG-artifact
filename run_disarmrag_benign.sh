...
# Default parameters
export SPLIT="test"
export QUERY_RESULTS_DIR="exp_benign"
...
export USE_PRETRAINED_CONTRIEVER="False"
export USE_PROMPT_CACHE="False"
export EDIT_CONTRIEVER="False"
...
ATTACK_METHODS=("LM_targeted" "hotflip" "gaslite")
